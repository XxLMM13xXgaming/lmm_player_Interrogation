...
net.Receive("LMMPIInterrorBeginCalling",function()
	...
	ForceMOTD:SetImage( "icons/LMMPI_information.png" )
	...
	BanPlayer:SetImage( "icons/LMMPI_bomb.png" )
	...
	KickPlayer:SetImage( "icons/LMMPI_door_out.png" )
	...
	FreezePlayer:SetImage( "icons/LMMPI_control_pause_blue.png" )
	...
	Up:SetPos( 110, 345 )
	Up:SetImage( "icons/LMMPI_arrow_up.png" )
	Up:SizeToContents()
	Up.DoClick = function()
	...
	Down:SetPos( 135, 345 )
	Down:SetImage( "icons/LMMPI_arrow_down.png" )
	Down:SizeToContents()
